    ...
    return (
        <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
            ...
            transition={{duration:0.7}}>
                ...
                bg-clip-text text-transparent'>
                    You get <span className='font-semibold'>5 FREE credits</span> to create
                    exam notes, project notes, charts, graphs and
                    download clean PDFs - instantly using AI.
                </p>
                <p className = 'mt-4 text-gray-500'> Start with 50 free credits • Upgrade anytime for more credits • Instant access
                </p>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                    ...
                    exam-oriented notes." />
                    <Feature icon="📁" title="Project Notes" des="Well structured documentation for assignment & projects." />
